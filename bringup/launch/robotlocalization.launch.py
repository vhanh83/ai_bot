...
def generate_launch_description():
    ...
    default_params_file = os.path.join(get_package_share_directory("ai_bot"),
                                       'config', 'mapping_params_online_localization.yaml')
    ...
    rviz_config_file = os.path.join(get_package_share_directory("ai_bot"),
